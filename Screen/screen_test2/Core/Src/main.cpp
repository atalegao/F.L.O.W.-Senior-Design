...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level BS generated by IOC
//  HAL_GPIO_WritePin(GPIOA, RA8875_CS_Pin|GPIO_PIN_8, GPIO_PIN_RESET);
//
//  /*Configure GPIO pin Output Level */
//  HAL_GPIO_WritePin(GPIOB, LCD_RESET_Pin|LCD_WAIT_Pin|GPIO_PIN_6, GPIO_PIN_RESET);
//
//  /*Configure GPIO pin Output Level */
//  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(LCD_RESET_GPIO_Port, LCD_RESET_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCD_WAIT_GPIO_Port, LCD_WAIT_Pin, GPIO_PIN_RESET);
